...
export const Todo = ({ width, height, ...props }: TodoProps) => {
  return (
    <div className={props.className}>
      ...
      >
        <path
          d="M26.5491 7.66507L25.5569 6.67398C24.9562 6.07205 23.9812 6.07327 23.3793 6.67398L22.452 7.60245L25.6208 10.7712L26.5491 9.84378C27.1499 9.24197 27.1499 8.267 26.5491 7.66507H26.5491Z"
          fill="#FF963C"
        />
        <path
